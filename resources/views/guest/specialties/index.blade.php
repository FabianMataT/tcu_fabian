    ...
    <section class="mb-24 sm:m-5 md:m-10 lg:m-16">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach ($specialties as $index => $specialtie)
                ...
                @endphp
                <a href="{{ route('guest.specialties.show', $specialtie) }}">
                    <div
                        class="bg-white rounded-xl shadow-lg overflow-hidden transition-transform duration-300 hover:shadow-xl hover:-translate-y-2 {{ $animationClass }}">
                        <div class="h-48 bg-blue-200 relative">
                            <img src="{{ $specialtie->image }}" alt="Programa de Bachillerato"
                                class="w-full h-full object-cover">
                            <div class="absolute top-0 left-0 bg-blue-600 text-white py-1 px-4 rounded-br-lg">Técnico
                                Medio
                            </div>
                        </div>
                        <div class="p-6">
                            ...
                            <p class="text-blue-600 font-semibold hover:text-blue-800 flex items-center">
                                Ver detalles
                            </p>
                        </div>
                    </div>
