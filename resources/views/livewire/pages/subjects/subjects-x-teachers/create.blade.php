<div>
    <x-mary-card title="{{ __('Asignar un profesor a una materia') }}"
        subtitle="{{ __('Reñene todos los campos para asignar el profesor a la materia que impartira') }}" shadow
            ...
            <div class="flex flex-col sm:flex-row gap-4 w-full">
                <div class="w-full">
                    <x-mary-select label="{{ __('Especialidad') }}" :options="$specialties" option-label="acronym"
                        placeholder="Seleccione una especialidad" placeholder-value="" wire:model="specialtie_id" wire:change="new_specialtie_id"/>
                </div>
                <div class="w-full">
