<div>
    <x-mary-card title="{{ __('Registrar un Estudiante')}}"
        subtitle="{{ __('Reñene todos los campos para registrar un nuevo estudiante') }}"
            ...
            <div class="flex flex-col sm:flex-row gap-4 w-full">
                <div class="w-full">
                    <x-mary-select label="{{ __('Nivel') }}" :options="$levels" option-value="id"
                        ...
                        wire:model="level_id" wire:change="loadGrups" />
                </div>
                <div class="w-full">
