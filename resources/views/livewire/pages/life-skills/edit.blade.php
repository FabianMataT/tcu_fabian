<div>
    <x-mary-card title="{{ __('Actualizar la habilidad de desarrollo humanao') }}"
        subtitle="{{ __('Reñene todos los campos para actualizar un nueva habilidad de desarrollo humano') }}" shadow
