...
<x-dialog-modal wire:model.live="confirmingPassword">
    ...
    <x-slot name="content">
        ...
        <div class="mt-4" x-data="{}"
            ...
            <x-mary-input id="confirmable-password" type="password" class="mt-1 block w-3/4"
                placeholder="{{ __('Password') }}" autocomplete="current-password" x-ref="confirmable_password"
